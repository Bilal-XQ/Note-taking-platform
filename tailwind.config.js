  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        '6xl': ['56px', { lineHeight: '68px' }],
        '7xl': ['64px', { lineHeight: '76px' }],
      },
      spacing: {
        '18': '4.5rem',   // 72px
        '20': '5rem',     // 80px
      ...
      backgroundImage: {
        ...
        'gradient-neon': 'linear-gradient(135deg, #10b981 0%, #6ee7b7 100%)',
        'gradient-coral': 'linear-gradient(135deg, #ff6b6b 0%, #fca5a5 100%)',
      },
      boxShadow: {
